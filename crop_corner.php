<?php
    ...
    if(isset($_POST['submit'])){
        ...
        if($fileerror==0){
             ...
             $insertuery = "insert into crop (pic,pname,pprice,pavailable,plocation,pno) values 
...
<body>
    ...
    <h1>Crop Item<i class="fa fa-shopping-cart" style="font-size:48px;color:yellowgreen;float: right;"></i></h1>
    ...
    <script src="veg_corner.js"></script>  
</body>
</html>