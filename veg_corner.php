...
<body>
    ...
    <h1>Vegetable Item<i class="fa fa-shopping-cart" style="font-size:48px;color:yellowgreen;float: right;"></i></h1>
      ...
      <table >
            ...
            { ?>
              ...
              <tr >
                ...
                <td class="card"><?php echo '<b>Contact<br><br>'.$result['pno'].'<br><br><a href="profile.php"><style="color: MediumTurquoise"></i>SEE MORE</a>'; ?></td>
                </tr>
